        ...
        <div className="relative overflow-hidden rounded-lg bg-gradient-namsa p-6 text-primary-foreground">
          <div className="relative z-10">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <div className="px-3 py-2 bg-muted rounded-md text-sm flex items-center gap-2">
                <span className="text-muted-foreground">Artist ID:</span>
                <span className="font-semibold text-black dark:text-white">{(profile as any)?.ArtistId || (profile as any)?.artistId || '-'}</span>
              </div>
              <div className="px-3 py-2 bg-muted rounded-md text-sm flex items-center gap-2">
                <span className="text-muted-foreground">IPI:</span>
                <span className="font-semibold text-foreground">{(profile as any)?.IPI_number || (profile as any)?.ipi_number || (profile as any)?.ipiNumber || '-'}</span>
              </div>
            </div>
          </div>
          ...
          <Card className="border-namsa-warning bg-namsa-warning/5">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <Button variant="outline" size="sm" onClick={() => navigate('/artist/profile')} className="w-full sm:w-auto">
                  <User className="w-4 h-4 mr-2" />
                  Complete Profile
                </Button>
                <Button variant="outline" size="sm" onClick={() => navigate('/artist/documents')} className="w-full sm:w-auto">
        ...
        <Card>
          <CardHeader>
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <Button variant="outline" onClick={() => navigate('/artist/music')} className="w-full sm:w-auto">
                View All
              </Button>
            </div>
          </CardHeader>
