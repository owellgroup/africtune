                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Input value={(viewingMusic as any).isrc_code || 'Pending'} disabled />
                    </div>
                    <div>
                      <Label>Status</Label>
                      <div className="pt-2">
          ...
          <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                {editCurrentPage === 2 && (
                  <Button variant="outline" onClick={() => setEditCurrentPage(1)} className="w-full sm:w-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:ml-auto w-full sm:w-auto">
                  <Button variant="outline" onClick={() => setEditingMusic(null)} className="w-full sm:w-auto">
                    Cancel
                  </Button>
                  
                  {editCurrentPage === 1 ? (
                    <Button onClick={() => setEditCurrentPage(2)} className="w-full sm:w-auto">
                      Next: File & Details
